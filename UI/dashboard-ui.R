...
# Header ----
header <- dashboardHeader(title = "Analysis Mode")

# Sidebar ----
sidebar <- dashboardSidebar(
  sidebarMenu(
    menuItem("Optimize Sequences", tabName = "optimization", icon = icon("fas fa-clipboard-check")),
    menuItem("Analyze Sequences", tabName = "analysis", icon = icon("fas fa-calculator")),
    collapsed = TRUE
  )
