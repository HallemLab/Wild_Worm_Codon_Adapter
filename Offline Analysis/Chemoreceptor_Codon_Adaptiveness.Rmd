...
Ce.tr.seq <- getBM(attributes=c('wormbase_gseqname', 'wbps_transcript_id', 'cdna'),
  ...
  dplyr::rename(geneID = wormbase_gseqname, transcriptID = wbps_transcript_id, cDNA = cdna)
Ce.tr.seq$cDNA <- tolower(Ce.tr.seq$cDNA)

write.table(Ce.tr.seq, 
            file = "./Data/Ce_chemosensory_cDNA_list.csv", 
            sep = ",", 
            col.names = FALSE, 
            row.names = FALSE)

# S. stercoralis ----
temp <- c(Ss = './Data/Ss_chemoreceptors.csv')
...
## For stercoralis, match wormbase gene sequence name to the wbsp transcript id, 
## and pull the cDNA sequence
Ss.tr.seq <- getBM(attributes=c('wbps_gene_id','wbps_transcript_id', 'cdna'),
                   # grab the cDNA sequences for the given genes from WormBase Parasite
                   mart = useMart(biomart="parasite_mart",
                                  dataset = "wbps_gene",
                                  host="https://parasite.wormbase.org",
                   ...
                   filters = c('species_id_1010',
                               'wbps_transcript_id'),
                   values = list('ststerprjeb528',
                                 genelist.Ss$Transcript_ID),
                   useCache = T) %>%
  as_tibble() %>%
  #we need to rename the columns retreived from biomart
  dplyr::rename(geneID = wbps_gene_id, transcriptID = wbps_transcript_id, cDNA = cdna)
Ss.tr.seq$cDNA <- tolower(Ss.tr.seq$cDNA)

write.table(Ss.tr.seq, 
            file = "./Data/Ss_chemosensory_cDNA_list.csv", 
            sep = ",", 
            col.names = FALSE, 
            row.names = FALSE)
...
## and pull the cDNA sequence
Sr.tr.seq <- getBM(attributes=c('wbps_gene_id','wbps_transcript_id', 'cdna'),
                   # grab the cDNA sequences for the given genes from WormBase Parasite
                   mart = useMart(biomart="parasite_mart",
                                  dataset = "wbps_gene",
                                  host="https://parasite.wormbase.org",
...
write.table(Sr.tr.seq, 
            file = "./Data/Sr_chemosensory_cDNA_list.csv", 
            sep = ",", 
            col.names = FALSE, 
            row.names = FALSE)
...
##  and pull the cDNA sequence
Sv.tr.seq <- getBM(attributes=c('wbps_transcript_id', 'wbps_gene_id','cdna'),
                   # grab the cDNA sequences for the given genes from WormBase Parasite
                   mart = useMart(biomart="parasite_mart",
                                  dataset = "wbps_gene",
                                  host="https://parasite.wormbase.org",
...
write.table(Sv.tr.seq, 
            file = "./Data/Sv_chemosensory_cDNA_list.csv", 
            sep = ",", 
            col.names = FALSE, 
            row.names = FALSE)
```
...
temp <- c(Ss_GoI = './Data/Ss_Chemoreceptor_Codon_Usage_Report.xlsx',
          Sr_GoI = './Data/Sr_Chemoreceptor_Codon_Usage_Report.xlsx',
          Sv_GoI = './Data/Sv_Chemoreceptor_Codon_Usage_Report.xlsx',
          Ce_GoI = './Data/Ce_Chemoreceptor_Codon_Usage_Report.xlsx')
