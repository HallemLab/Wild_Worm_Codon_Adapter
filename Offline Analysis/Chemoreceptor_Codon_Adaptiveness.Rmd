...
# C. elegans ----
temp <- c(Ce = 'Ce_chemoreceptors.csv')
...
# S. ratti ----
temp <- c(Sr = 'Sr_chemoreceptors.csv')
...
# S. venezuelensis ----
temp <- c(Sv = 'Sv_chemoreceptors.csv')
...
ggsave('ChemoreceptorVSallgene_CAIDistributions.pdf', plot = goi_species_adaptiveness_plot, 
        width = 11, height = 8, 
       units = "in", device = "pdf", 
       useDingbats = FALSE)
